...
const cylinderVolume = Math.round(3.1415 * Math.pow(radius, 2) * height); // Math.PI - це замість 3.1415 (пі)
...
alert(`Отримайте його "перевертень" — ${userNumber.split("").reverse().join("")}.`); // можна розв'язувати через slice() та ділення %
